...
- **`member_body` and deleting a member's body data when they leave the household are phase 2**, not built yet. The exact spot to hook that in is marked with a `FASE 2` comment in `supabase/migrations/20260920090200_rezet_member_lifecycle.sql`.
